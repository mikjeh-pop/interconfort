    ...
    <Container>
      <div className="max-w-2xl py-28 sm:py-40">
        ...
        <p className="mt-8 text-lg leading-relaxed text-ink-2">
          Nous revenons vers vous rapidement. Si votre projet est urgent,
        ...
        <p className="mt-6 leading-relaxed text-ink-2">
          Pour joindre des photos, des plans ou des fiches produit, répondez
          simplement à l’e-mail que vous allez recevoir.
        </p>
