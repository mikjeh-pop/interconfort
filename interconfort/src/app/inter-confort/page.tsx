  ...
  return (
    <>
        ...
        <Container>
          <div className="max-w-4xl py-16 sm:py-24">
            ...
            <p className="mt-8 max-w-2xl text-lg leading-relaxed text-ink-2">
              Installée à Nivelles, en {societe.adresse.region}, Inter-Confort conçoit, importe,
              configure et installe des distributeurs automatiques pour les professionnels. Notre
              clientèle réunit fabricants, commerçants, artisans et opérateurs qui cherchent un
              équipement capable de porter leurs produits, pas seulement de les vendre.
            </p>
          </div>
        </Container>
        <RuleTick />
      ...
      <section className="border-b border-ink/10 py-20 sm:py-24">
        <Container>
          <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            <TitreSection eyebrow="Histoire">Une spécialité, tenue dans la durée.</TitreSection>
            <div className="space-y-6 text-lg leading-relaxed text-ink-2">
              <p>
                Inter-Confort exerce depuis {societe.depuis} dans le vending et le snacking. Cette
                ancienneté a une conséquence concrète : nous avons vu passer suffisamment de projets
                pour savoir rapidement ce qui fonctionnera et ce qui posera problème, qu’il s’agisse
                d’un emballage mal adapté ou d’un emplacement trop exposé.
              </p>
              <p>
                Notre activité couvre la représentation, la commercialisation, la vente et le
                service après-vente des appareils Inter-Confort, Magex et Pharmashop auprès des
                entreprises, commerçants, fabricants, opérateurs et revendeurs.
              </p>
              <p>
                Ce double statut — concepteur de nos propres machines et intégrateur de technologies
                éprouvées — nous permet de ne pas forcer une solution unique. Le Fresh Food Store est
                une conception Inter-Confort ; d’autres besoins trouvent une meilleure réponse dans
                les configurations Magex ou Pharmashop.
              </p>
            </div>
          </div>
        </Container>
      ...
      <section className="border-b border-ink/10 bg-paper-2 py-20 sm:py-24">
        <Container>
          <TitreSection eyebrow="Philosophie">Comment nous travaillons.</TitreSection>
      ...
      <section className="border-b border-ink/10 py-20 sm:py-24">
        <Container>
          <TitreSection eyebrow="Vos interlocuteurs">Qui suit votre région.</TitreSection>
          <div className="mt-12 grid gap-10 border-t border-ink/15 pt-10 md:grid-cols-2">
            {societe.contacts.map((c) => (
              <div key={c.email}>
                ...
                <p className="mt-2 text-sm leading-relaxed text-steel">{c.zone}</p>
                <p className="mt-4 text-sm">
                  <a href={`mailto:${c.email}`} className="text-cold underline-offset-4 hover:underline">
                    {c.email}
                  </a>
                </p>
