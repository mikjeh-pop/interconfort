    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(productLd(solution)),
        }}
      />
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(faqLd(solution.faq)),
        }}
      />
      <script
        type="application/ld+json"
      ...
      <section
        ...
        className="scroll-mt-24 bg-cold text-white"
      >
        <RuleTick clair />
        <Container>
          <div className="grid gap-12 py-20 sm:py-24 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
            ...
            <div>
              ...
              <p className="mt-6 text-xs leading-relaxed text-frost/70">
                Données indicatives. La configuration finale est validée après
                étude des produits, des emballages et de l’emplacement.
              </p>
            </div>
          </div>
        </Container>
